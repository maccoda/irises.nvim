...
local groups = {
  ...
  NormalFloat = { fg = colors.fg2, bg = colors.bg3 },
  FloatBorder = { fg = colors.fg2, bg = colors.bg3 },
  FloatTitle = { fg = colors.iris_blue, bg = colors.bg3 },
  NormalNC = { fg = colors.fg0, bg = colors.bg0 },
  Pmenu = { bg = colors.bg3, fg = colors.fg2 },
  PmenuMatch = { fg = colors.fg0 },
  PmenuSbar = { bg = colors.bg2 },
  PmenuSel = { bg = colors.selection, bold = true },
  PmenuKind = { bg = colors.bg3, fg = colors.fg1 },
  ...
  -- Gitsigns
  GitSignsAdd = { fg = colors.diff_add_fg },
  GitSignsChange = { fg = colors.diff_change_fg },
  GitSignsDelete = { fg = colors.diff_delete_fg },
  ...
  -- Mini Pick
  MiniPickMatchCurrent = { bg = colors.selection, fg = colors.fg0, bold = true },
  MiniPickPrompt = { bg = colors.bg3, fg = colors.iris_blue },
}
